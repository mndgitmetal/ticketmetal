...
const LogoLockup: React.FC<LogoLockupProps> = ({ 
  ...
  if (variant === 'simple') {
    return (
      <div className={`flex items-center ${className}`}>
        ...
        <div className={`font-black metal-text text-red-400 ${sizeClasses[size]}`} 
  ...
  if (variant === 'vertical') {
    return (
      <div className={`flex flex-col items-center space-y-3 ${className}`}>
        ...
        <div className={`flex flex-col items-center space-y-2 ${mndSizeClasses[size]} text-gray-400`}>
          ...
          >
            ...
            <span className="font-black text-white group-hover:text-gray-200 transition-colors" 
  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      ...
      {/* Powered by Metal Never Die */}
      <div className={`flex items-center space-x-2 ${mndSizeClasses[size]} text-gray-400`}>
        <span style={{ fontFamily: 'Rajdhani, sans-serif' }}>powered by</span>
